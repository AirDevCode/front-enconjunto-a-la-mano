        ...
        <div className="col-lg-6">
          {!itisaprovedbytheadm ? (
            <div className="alert alert-danger">
              En espera de aprobación por parte del administrador.
            </div>
          ) : null}
            ...
            <div className="row align-items-center gx-2">
              ...
              <div className="col-sm-6 mb-2" key={data.city_id}>
                <div className="form-check">
                  <input className="form-check-input" type="checkbox" checked={selectedCoverages.includes(data.city_id)} id={data.city_id} onChange={() => handleCoverages(data.city_id)} />
