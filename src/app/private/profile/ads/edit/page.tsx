  ...
  const permanentlyDelete = () => {
    ...
    .then((responseData:any) => {
      ...
      if(responseData.success == true){
        ...
        router.push('/private/profile/ads/list');
      }
    }).catch((error) => {console.error('Wrong:', error);})
  }
  const deleteAds = () => {
  ...
  return (
    <Private>
      <div className="px-md-4 px-lg-5">
        ...
        <ModalSuccess showModalSuccess={showModalSuccess} setShowModalSuccess={setShowModalSuccess} showButtonCloseModal={showButtonCloseModal} msgApi={msgApi} />

        <ModalError showModalError={showModalError} setShowModalError={setShowModalError} msgApi={msgApi} />
        ...
        <div className="bg-white py-4 py-sm-5">
          <div className="container py-md-3">
            <h4 className="mb-4 mt-0 baloo fw-400 fz-26 text-grey-6">Perfil / Mis Anuncios / <span className="text-success">Editar anuncio</span></h4>
