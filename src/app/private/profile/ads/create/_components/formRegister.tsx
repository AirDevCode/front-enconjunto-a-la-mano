...
import UploadMultipleFiles from "../../../_components/uploadMultipleFiles";
...
export default function FormRegister({
  ...
  return (
    <form onSubmit={handleSubmit} className="w-100">
      <div className="row gx-lg-4 gx-xl-5">
        <div className="col-lg-6">
          ...
          <div className="row gx-1 gx-sm-2 gx-lg-3 grid-photos mb-3">
            <div className="col-6">
              <div className="grid">
                <i onClick={deleteQr} className="fa-solid fa-xmark text-white delete-img"></i>
            ...
            <div className="row align-items-center gx-2">
              ...
              <div className="col-sm-6 mb-2" key={data.city_id}>
                <div className="form-check" >
                  ...
                  />
                  <label className="form-check-label my-0 text-dark fw-400" htmlFor={data.city_id}>
                    {data.city_name}
                  </label>
                </div>
              </div>
      ...
      <button type="submit" className="btn btn-orange-1 d-table mx-auto mt-3 mt-md-4 baloo text-uppercase fw-400 fz-18 fz-sm-24 pb-1 px-4 px-md-5">
        Publicar anuncio
      </button>
    </form>
  );
