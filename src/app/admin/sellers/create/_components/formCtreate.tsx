...
export default function FormCtreate(
    {
        handleSubmit,
        handleSelectChange,
        ...
        cityId,setCityId,
        ensembleId,setEnsembleId,
        liveInEnsamble,
        numberapartTower,setNumberApartTower,
        kindSex,setKindSex,
     ...
     <form onSubmit={handleSubmit} className="w-100">
        <div className="row gx-lg-4 gx-xl-5">
            <div className="col-lg-6">
                ...
                <select 
                    ...
                    required
                >
                    <option value="" className="d-none">Tipo de documento</option>
               ...
               <div className="form-group mb-3">
                ...
                <div className="form-group mb-3">
                    <select
                        ...
                        className="form-control form-control-outline form-select"
                        value={cityId}
                        onChange={(event) => handleSelectChange(event, setCityId,'city')}
                        required
                    >
                    <option value="" className="d-none">Selecciona la ciudad</option>
                ...
                <select
                        ...
                        required
                    >
                    <option value="" className="d-none">Buscar por conjunto</option>
                ...
                <div className="form-group mb-3">
                    ...
                    />
                        ...
                        Si no vives en un conjunto o urbanismo de CB selecciona esta opción
                        </label>
                    </div>
                </div>
                <div className="form-group mb-3">
            ...
            <div className="col-lg-6 mt-4 mt-lg-0">
               <div className="form-group mb-3">
                    <select 
                        ...
                        required
                    >
                        <option value="" className="d-none">Género</option>
                ...
                <div className="form-group mb-3">
                    <p className="my-0 text-dark fw-400">Selecciona si te identificas con uno o con varios de estos grupos:</p>
                </div>
                <div className="form-group mb-3">
                    ...
                    {apiTypePersonData.map((typePerson:any) => (
                        ...
                        <input
                            className="form-check-input"
                            type="checkbox"
                            checked={selectedCheckboxes.includes(typePerson.typeperson_id)}
                ...
                <div className="profile-seller md-version d-sm-flex align-items-center justify-content-center mt-4">
                    <div className="img">
                        {profileImage ? (
                            <Image
                                src={process.env.NEXT_PUBLIC_API+profileImage}
                    ...
                    <div className="info text-center text-sm-start mt-4 mt-sm-0 ps-sm-4 pe-sm-3">
                        <div className="form-group my-0">
                            <input className="form-control form-control-outline only-button" 
                                type="file" 
                                id="photo_profile" 
                                accept="image/*"
        ...
        <div className="row gx-sm-4 gx-md-5 align-items-center mt-3 mt-md-4">
            <div className="col-sm-8">
                <button type="submit" className="btn btn-orange-1 d-table mx-auto me-sm-0 baloo text-uppercase fw-400 fz-18 fz-sm-24 pb-1 px-4 px-md-5">Guardar</button>
            </div>
        </div>
    </form>
    </>)
