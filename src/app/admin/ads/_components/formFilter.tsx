    ...
    <div className="breadcrumb m-0 border-0 rounded-0 py-5 px-md-4 px-lg-5">
      <div className="container py-sm-3">
        <div className="form-filter-banner p-3 px-md-4">
          <form onSubmit={handleSubmitFilter} role="search">
            <div className="row align-items-end">
              <div className="col-lg-4 col-xl-3">
                <div className="card bg-success text-white text-center">
                  <div className="card-body">
                    <h3 className="fw-700 my-0 fz-24">{getTotalRegistered}</h3>
                    <p className="mt-2 mb-0 fw-500 fz-16">Anuncios subidos</p>
                  </div>
                </div>
              </div>
              <div className="col-lg-8 col-xl-9 mt-2 mt-md-4 mt-lg-0">
            ...
            <div className="row mt-3 mt-md-4 gx-2 gx-xl-3">
              ...
              <div className="col-sm-6 col-md-4 mb-3 mb-lg-0">
                ...
                <div className="form-group mt-1 mb-0">
                  <select className="form-control form-select w-100" value={selectedFilter} onChange={(e) => setSelectedFilter(e.target.value)}>
                    <option value="" className="d-none">
                      Filtrar por...
                    </option>
                    <option value="">Todos los anuncios</option>
                    <option value="pending"> Pendiente por aprobacion</option>
