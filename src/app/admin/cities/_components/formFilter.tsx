          ...
          <form onSubmit={handleSubmitFilter}>
            <div className="row align-items-end justify-content-center">
              <div className="col-sm-6">
                <Link href={{ pathname: '/admin/cities/create' }} className="btn btn-orange-1 d-table mx-auto ms-lg-0 baloo text-uppercase fw-400 fz-18 pb-1 px-4 rounded">Agregar ciudad</Link>
              </div>
              ...
              <div className="col-sm-8 col-lg-9 mt-3 mt-md-4">
                ...
                <div className="form-group mt-1 mb-0">
                  <input type="search" id="search" placeholder="Palabra clave" className="form-control w-100 my-0" value={nameFilter} onChange={(e) => setNameFilter(e.target.value)} />
                </div>
              </div>
            </div>
